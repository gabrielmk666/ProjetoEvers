...
public class JanelaLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextFieldLogin.setToolTipText("digite um login válido");
        ...
        jLabelLogin.setBounds(280, 80, 50, 20);

        jLabelSenha.setFont(new java.awt.Font("Arial", 0, 16)); // NOI18N
        jLabelSenha.setText("Senha:");
        getContentPane().add(jLabelSenha);
        jLabelSenha.setBounds(280, 120, 50, 20);

        jPasswordFieldSenha.setToolTipText("digite uma senha válida");
    ...
    private void jButtonEntrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEntrarActionPerformed
       ...
       if(jTextFieldLogin.getText().equals("admin")&& jPasswordFieldSenha.getText().equals("admin")){
        ...
        con.conexao();
        jButtonEntrar.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        dispose();
        }else {
